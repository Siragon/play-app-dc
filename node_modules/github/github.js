...
(function() {
  ...
  var Github = function(options) {
    ...
    Github.User = function() {
      ...
      // Show watchers information
      // -------

      this.subscribers = function(username, cb) {
        var command = username ? "/users/"+username+"/subscriptions" : "/user/subscriptions";
      ...
      this.orgEvents = function(username, orgname, cb) {
        _requestAllPages("/users/"+username+"/events/orgs/"+orgname, function(err, res) {
          cb(err, res);
        });
      };
